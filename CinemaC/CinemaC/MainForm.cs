namespace CinemaC
{
    public partial class MainForm : Form
    {
        ...
        public void DataStart()
        {
            ...
            {
                //выбор названия фильма по ид возможно не оч точен
                dataGridView1.Rows.Add(Data.GetSessionID(Data.Sessions[i]), Data.Sessions[i].Date.ToLongDateString(), Data.Sessions[i].Time.ToString().Remove(5,3), Data.Halls[Data.Sessions[i].Hall - 1].NameHall, Data.Movies[Data.Sessions[i].Movie - 1].NameMovie);
            }
        }
        ...
        private void AccountChanged()
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Пароль не верный. Вы остались пользователем", "Уведомление");
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            for(int i = 0; i < count; i++)
            {
                if (labelID == 1)
                {
                    ...
                    {
                        dataGridView1.Rows.Add(Data.GetSessionID(Data.Sessions[i]), Data.Sessions[i].Date.ToLongDateString(), Data.Sessions[i].Time.ToString().Remove(3, 3), Data.Sessions[i].Hall, Data.Movies[Data.Sessions[i].Movie - 1].NameMovie);
                    }
                }
                else if (labelID == 2)
                {
